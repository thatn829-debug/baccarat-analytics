...
# =========================================================================
# INTERFACE: SUPREME COMPACT PRO V6 (ADAPTED VIEW)
# =========================================================================
...
# --- SIDEBAR CẤU HÌNH (NƠI CHỨA PHẦN NHẬP SỐ VÁN THAY ĐỔI) ---
st.sidebar.header("⚙️ Cấu Hình")
decks = st.sidebar.selectbox("Số bộ bài:", [8, 6, 4], index=0)

# Chuyển thành công cấu hình Số Ván vào Sidebar
st.session_state.game_counter = st.sidebar.number_input(
    "Cài đặt Số ván (Game No.):", 
...
# --- MÀN HÌNH CHÍNH ƯU TIÊN 1: BẢNG KẾT QUẢ ĐẦY ĐỦ ---
if st.session_state.last_results:
    ...
    with st.expander("📊 Chi tiết ma trận khay bài"):
        ...
        st.write(f"Bài đã chạy (ước tính): **{est_played} / {total_cards}** lá.")
        cols = st.columns(5)
...
with status_col:
    # HIỂN THỊ SỐ VÁN RA NGOÀI (Chỉ đọc trạng thái, không làm vướng không gian nhập)
    st.markdown(
